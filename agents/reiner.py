...
# Example of creating and interacting with the reiner agent
if __name__ == "__main__":
    ...
    # Processing events
    reiner.process_event(event1)
    reiner.process_event(event2)
    reiner.process_event(event3)